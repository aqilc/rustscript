...
static const x64LookupGeneralIns x64Table[] = {
	{ "adc", 22, (struct x64LookupActualIns[]) { {
		.immediate = SIZE_BYTE,
		...
		.reg_operand = 1,
		.opcode = { 0x13 }, .oplen = 1,
		.args = { R64, R64 | M64 }, .arglen = 2,
	} } },
	{ "add", 22, (struct x64LookupActualIns[]) { {
		.immediate = SIZE_BYTE,
	...
	{ "and", 22, (struct x64LookupActualIns[]) { {
		.immediate = SIZE_BYTE,
	...
	{ "cmp", 22, (struct x64LookupActualIns[]) { {
		.immediate = SIZE_BYTE,
	...
	{ "crc32", 6, (struct x64LookupActualIns[]) { {
		.modrm = 0xC0,
	...
	{ "dec", 5, (struct x64LookupActualIns[]) { {
		.modrm = 0xC8,
	...
	{ "div", 5, (struct x64LookupActualIns[]) { {
		.modrm = 0xC8,
	...
	{ "enter", 3, (struct x64LookupActualIns[]) { {
		.immediate = SIZE_BYTE,
		.orig_ins = "ENTER 0, imm16", .orig_opcode = "C8 ib iw",
		.desc = "Create a stack frame for a procedure.",
		.opcode = { 0xC8 }, .oplen = 1,
		.args = { 0, IMM16 }, .arglen = 2,
	}, {
		.immediate = SIZE_BYTE,
		.orig_ins = "ENTER 1, imm16", .orig_opcode = "C8 ib iw",
		.desc = "Create a nested stack frame for a procedure.",
		.opcode = { 0xC8 }, .oplen = 1,
		.args = { 1, IMM16 }, .arglen = 2,
	}, {
		.immediate = SIZE_BYTE,
	...
	{ "extractps", 1, (struct x64LookupActualIns[]) { {
		...
		.args = { R64 | R32 | M32, XMM, IMM8 }, .arglen = 3,
	} } },
	...
	{ "idiv", 5, (struct x64LookupActualIns[]) { {
		.modrm = 0xC8,
	...
	{ "imul", 14, (struct x64LookupActualIns[]) { {
		.modrm = 0xC8,
		...
		.reg_operand = 1,
		.opcode = { 0x6B }, .oplen = 1,
		.args = { R16, R16 | M16, IMM8 }, .arglen = 3,
	}, {
		.modrm = 0xC0,
		.immediate = SIZE_BYTE,
		...
		.reg_operand = 1,
		.opcode = { 0x6B }, .oplen = 1,
		.args = { R32, R32 | M32, IMM8 }, .arglen = 3,
	}, {
		.rex = 0x48, 
		.modrm = 0xC0,
		.immediate = SIZE_BYTE,
		...
		.reg_operand = 1,
		.opcode = { 0x6B }, .oplen = 1,
		.args = { R64, R64 | M64, IMM8 }, .arglen = 3,
	}, {
		.modrm = 0xC0,
		.immediate = SIZE_WORD,
		...
		.reg_operand = 1,
		.opcode = { 0x69 }, .oplen = 1,
		.args = { R16, R16 | M16, IMM16 }, .arglen = 3,
	}, {
		.modrm = 0xC0,
		.immediate = SIZE_DWORD,
		...
		.reg_operand = 1,
		.opcode = { 0x69 }, .oplen = 1,
		.args = { R32, R32 | M32, IMM32 }, .arglen = 3,
	}, {
		.rex = 0x48, 
		.modrm = 0xC0,
		.immediate = SIZE_DWORD,
		...
		.reg_operand = 1,
		.opcode = { 0x69 }, .oplen = 1,
		.args = { R64, R64 | M64, IMM32 }, .arglen = 3,
	} } },
	...
	{ "inc", 5, (struct x64LookupActualIns[]) { {
		.modrm = 0xC8,
	...
	{ "mov", 40, (struct x64LookupActualIns[]) { {
		.modrm = 0xC0,
	...
	{ "movsx", 7, (struct x64LookupActualIns[]) { {
		.modrm = 0xC0,
	...
	{ "movzx", 7, (struct x64LookupActualIns[]) { {
		.modrm = 0xC0,
	...
	{ "mul", 5, (struct x64LookupActualIns[]) { {
		.modrm = 0xC8,
	...
	{ "neg", 5, (struct x64LookupActualIns[]) { {
		.modrm = 0xC8,
	...
	{ "not", 5, (struct x64LookupActualIns[]) { {
		.modrm = 0xC8,
	...
	{ "or", 22, (struct x64LookupActualIns[]) { {
		.immediate = SIZE_BYTE,
	...
	{ "pextrb", 1, (struct x64LookupActualIns[]) { {
		...
		.args = { R64 | R32 | M8, XMM, IMM8 }, .arglen = 3,
	} } },
	{ "pextrd", 1, (struct x64LookupActualIns[]) { {
		...
		.args = { R32 | M32, XMM, IMM8 }, .arglen = 3,
	} } },
	{ "pextrq", 1, (struct x64LookupActualIns[]) { {
		...
		.prefixes = { 0x66 }, .preflen = 1,
		.opcode = { 0x0F, 0x3A, 0x16 }, .oplen = 3,
		.args = { R64 | M64, XMM, IMM8 }, .arglen = 3,
	} } },
	{ "pextrw", 3, (struct x64LookupActualIns[]) { {
		...
		.prefixes = { 0x66 }, .preflen = 1,
		.opcode = { 0x0F, 0xC5 }, .oplen = 2,
		.args = { R64 | R32, XMM, IMM8 }, .arglen = 3,
	}, {
		.modrm = 0xC0,
		.immediate = SIZE_BYTE,
		...
		.args = { R64 | R32 | M16, XMM, IMM8 }, .arglen = 3,
	} } },
	...
	{ "pinsrd", 1, (struct x64LookupActualIns[]) { {
		...
		.args = { XMM, R32 | M32, IMM8 }, .arglen = 3,
	} } },
	{ "pinsrw", 2, (struct x64LookupActualIns[]) { {
		...
		.prefixes = { 0x66 }, .preflen = 1,
		.opcode = { 0x0F, 0xC4 }, .oplen = 2,
		.args = { XMM, R32 | M16, IMM8 }, .arglen = 3,
	} } },
	...
	{ "rcr", 15, (struct x64LookupActualIns[]) { {
		.modrm = 0xC8,
	...
	{ "rol", 15, (struct x64LookupActualIns[]) { {
		.modrm = 0xC8,
	...
	{ "ror", 15, (struct x64LookupActualIns[]) { {
		.modrm = 0xC8,
	...
	{ "sal", 15, (struct x64LookupActualIns[]) { {
		.modrm = 0xC8,
	...
	{ "sar", 15, (struct x64LookupActualIns[]) { {
		.modrm = 0xC8,
	...
	{ "shl", 15, (struct x64LookupActualIns[]) { {
		.modrm = 0xC8,
	...
	{ "shr", 15, (struct x64LookupActualIns[]) { {
		.modrm = 0xC8,
	...
	{ "sbb", 22, (struct x64LookupActualIns[]) { {
		.immediate = SIZE_BYTE,
	...
	{ "shld", 6, (struct x64LookupActualIns[]) { {
		...
		.args = { R16 | M16, R16, IMM8 }, .arglen = 3,
	}, {
		...
		.reg_operand = 2,
		.opcode = { 0x0F, 0xA4 }, .oplen = 2,
		.args = { R32 | M32, R32, IMM8 }, .arglen = 3,
	}, {
		.rex = 0x48, 
		...
		.reg_operand = 2,
		.opcode = { 0x0F, 0xA4 }, .oplen = 2,
		.args = { R64 | M64, R64, IMM8 }, .arglen = 3,
	}, {
	...
	{ "sub", 22, (struct x64LookupActualIns[]) { {
		.immediate = SIZE_BYTE,
	...
	{ "xlatb", 2, (struct x64LookupActualIns[]) { {
		.orig_ins = "XLATB", .orig_opcode = "D7",
		.desc = "Set AL to memory byte DS:[(E)BX + unsigned AL].",
		.opcode = { 0xD7 }, .oplen = 1,
	}, {
		.rex = 0x48, 
	...
	{ "xor", 22, (struct x64LookupActualIns[]) { {
		.immediate = SIZE_BYTE,
