...
#define X64MEM_1_ARGS(base)                      (((base) & 0x10 ?\\
																										( ((uint64_t) ((base) == 0x20) ? ((uint64_t) 0x1 << 61) : 0) | ((uint64_t) ((base) == 0xfff0) ? ((uint64_t) 0x1 << 36) : 0) | ((uint64_t) ((base) & 0xf) << 32) ) :\\
...
#define X64MEM_5_ARGS(base, disp, index, scale, segment) (disp & 0xffffffff\\
	| ((base) & 0x10 ?\\
			( ((uint64_t) ((base) == 0x20) ? ((uint64_t) 0x1 << 61) : 0) | ((uint64_t) ((base) == 0xfff0) ? ((uint64_t) 0x1 << 36) : 0) | ((uint64_t) ((base) & 0xf) << 32) ) :\\
			((uint64_t) 0x1 << 60) | (uint64_t) ((base) & 0xf) << 32) /*If the operand is more than 32 bits wide or is equal to the RIP register, set mode to wide addressing and set base register, or RIP addressing*/\\
	| (uint64_t) ((index) == 0xfff0 ? 0x10 : (index) & 0xf) << 40\\
