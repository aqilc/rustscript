...
// REMEMBER VMX INSTRUCTIONS ARE FOR SOME REASON ONLY ON PAGE 2573 OR SOMETHING
// also here: https://docs.oracle.com/cd/E36784_01/html/E36859/gntbx.html#scrolltoc and https://www.felixcloutier.com/x86/invept
/**
...
for(let i in instruction_variants) {
	...
	if(operands?.[0]) {
		...
		if(row[0].includes("/is4")) variant += " .is4_oper = " + (row[2].lastIndexOf("R") + 1) + ",", (row[2].lastIndexOf("R") + 1) !== 4 ? console.log("BIG ERROR, IS4 NOT 4 for", row) : 0;
